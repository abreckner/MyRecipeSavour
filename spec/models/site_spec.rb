...
describe Site do
  ...
  context "add_recipe" do
    ...
    it "should find the recipe and save it" do
      ...
      site = Site.make!
      FakeWeb.register_uri(:get, url , :body => "<h1>Title Test</h1><ul id='methods'><li>method 1</li><li>method 2</li></ul><ul id='ingredients'><li>ingredient 1</li><li>ingredient 2</li><li>ingredient 3</li></ul><img class='image' src='/img.gif'/>")
      ...
      recipe.image.should == "http://www.taste.com.au/img.gif"
